    ...
    <>
      <div
        ...
        <div className="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
          ...
          <div>
            <img height='60px' width='60px' src='https://raw.githubusercontent.com/GustavoRuiz0/nonsafe_normal_images/main/icons/icons8-bitcoin-128.png?raw=true'/>
          ...
          <div>
            <img height='60px' width='60px' src='https://github.com/GustavoRuiz0/nonsafe_normal_images/blob/main/icons/icons8-bitcoin-128.png?raw=true'/>
